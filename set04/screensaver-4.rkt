...
;; screensaver-4.rkt: moving and draggable ranctangles.  
...
;; marks is the list of marks from where rectangle is travelled when pen is down.
...
(define RECT-AT_200_100-VEL_-12_20-UNSEL (make-rect 200 100 -12 20 false 0 0 false empty))
(define RECT-AT_188_120-VEL_-12_20-UNSEL (make-rect 188 120 -12 20 false 0 0 false empty))
(define RECT-AT_200_200-VEL_23_-14-UNSEL (make-rect 200 200 23 -14 false 0 0 false empty))
(define RECT-AT_223_186-VEL_23_-14-UNSEL (make-rect 223 186 23 -14 false 0 0 false empty))

(define RECT-AT_40_30-VEL_-12_-20-UNSEL (make-rect 40 30 -12 -20 false 0 0 false empty))
(define RECT-AT_30_25-VEL_12_20-UNSEL (make-rect 30 25 12 20 false 0 0 false empty))
(define RECT-AT_365_30-VEL_12_-20-UNSEL (make-rect 365 30 12 -20 false 0 0 false empty))
(define RECT-AT_370_25-VEL_-12_20-UNSEL (make-rect 370 25 -12 20 false 0 0 false empty))

(define RECT-AT_365_265-VEL_12_20-UNSEL (make-rect 365 265 12 20 false 0 0 false empty))
(define RECT-AT_40_270-VEL_-12_20-UNSEL (make-rect 40 270 -12 20 false 0 0 false empty))
(define RECT-AT_30_275-VEL_12_-20-UNSEL (make-rect 30 275 12 -20 false 0 0 false empty))
(define RECT-AT_40_100-VEL_-12_20-UNSEL (make-rect 40 100 -12 20 false 0 0 false empty))

(define RECT-AT_30_120-VEL_12_20-UNSEL (make-rect 30 120 12 20 false 0 0 false empty))
(define RECT-AT_100_35-VEL_-12_-20-UNSEL (make-rect 100 35 -12 -20 false 0 0 false empty))
(define RECT-AT_88_25-VEL_-12_20-UNSEL (make-rect 88 25 -12 20 false 0 0 false empty))
(define RECT-AT_360_100-VEL_12_20-UNSEL (make-rect 360 100 12 20 false 0 0 false empty))

(define RECT-AT_370_120-VEL_-12_20-UNSEL (make-rect 370 120 -12 20 false 0 0 false empty))
(define RECT-AT_100_260-VEL_12_20-UNSEL (make-rect 100 260 12 20 false 0 0 false empty))
(define RECT-AT_112_275-VEL_12_-20-UNSEL (make-rect 112 275 12 -20 false 0 0 false empty))

(define RECT-AT_370_275-VEL_-12_-20-UNSEL
  (make-rect 370 275 -12 -20 false 0 0 false empty))
...
(define NEW-RECTANGLE-AT-CENTER-OF-CANVAS
  (make-rect HALF-CANVAS-WIDTH HALF-CANVAS-HEIGHT INIT-VX INIT-VY false 0 0 false empty))
...
;; DESIGN STRATEGY: Use template for ListOfMarks on marks
(define (place-marks-on-scene marks scene)
  (cond
    ...
    [else (place-image DOT
                       (mark-x (first marks))
                       (mark-y (first marks))
                       (place-marks-on-scene (rest marks) scene))]))
...
;; GIVEN: the list of rectangle rects of some world state and arrow/d/u
;; key event kev
